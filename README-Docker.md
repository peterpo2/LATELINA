...
3. A strong SQL Server password that you will use for the demo database.
...
3. (Optional) Edit `Latelina.Backend/Latelina.Web/appsettings.json` and replace the email address, password, and SMTP host with your own values if you need working email.
...
If you change the SQL password rerun `docker-compose up --build` to reload the configuration.
